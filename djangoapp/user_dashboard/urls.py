...
from user_dashboard.views import (
    UserDashboardReportsFilterView,
    UserDashboardReportsView,
    admin_home,
    admin_site_config,
    classes_type,
    classes_type_create,
    classes_type_delete,
    classes_type_ordering,
    classes_type_single_class,
    classes_type_update,
    contact_single,
    contacts_management,
    section_eight,
    section_eight_create,
    section_eight_single_video,
    section_eight_single_video_delete,
    section_eight_single_video_update,
    section_five,
    section_five_card,
    section_five_card_create,
    section_five_card_delete,
    section_five_card_update,
    section_five_create,
    section_five_header,
    section_five_header_create,
    section_five_header_delete,
    section_five_offers_icons,
    section_five_offers_icons_create,
    section_five_offers_icons_delete,
    section_five_ordering_cards,
    section_five_price_card_icons,
    section_five_price_card_icons_create,
    section_five_price_card_icons_delete,
    section_five_pricing_offers,
    section_five_pricing_offers_create,
    section_five_pricing_offers_delete,
    section_five_single_card,
    section_four,
    section_four_create,
    section_four_ordering_photos,
    section_four_single_photo,
    ...
    section_six_create,
    section_six_delete,
    section_six_single_item,
    section_six_update,
    section_three,
    section_three_create,
    section_three_update,
    section_two,
    section_two_create,
    section_two_update,
)
...
urlpatterns = [
    ...
    # Contacts Management
    path('user_dashboard/contacts-management/',
         contacts_management, name='contacts_management'),
    path('user_dashboard/contact-single/<int:id>/',
         contact_single, name='contact_single'),
    # Aulas
